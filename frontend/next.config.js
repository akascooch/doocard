...
const nextConfig = {
  ...
  // Optimize images (remotePatterns preferred over deprecated domains)
  images: {
  ...
  async headers() {
    ...
    const frameSrc = isDevelopment
      ...
      : "'self' https://www.google.com https://www.google.com/maps https://maps.google.com https://maps.googleapis.com";
    const childSrc = isDevelopment
      ? "'self' blob: https://www.google.com https://www.google.com/maps https://maps.google.com https://maps.googleapis.com"
      : "'self' blob: https://www.google.com https://www.google.com/maps https://maps.google.com https://maps.googleapis.com";
  ...
  async rewrites() {
    // Prefer 127.0.0.1 over localhost on Windows to avoid IPv6 (::1) hangs
    const backendUrl =
