    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {toTomans(stats?.staffShareTotal || 0)}
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {toTomans(stats?.salonShareTotal || 0)}
            </div>
          </CardContent>
        </Card>
                  ...
                  {stats.transactions.map((transaction) => (
                    <TableRow key={transaction.id}>
                      <TableCell className="font-medium">
                        {toTomans(transaction.amount)}
                      </TableCell>
                      <TableCell>
                        {transaction.staffShare != null
                          ? toTomans(transaction.staffShare)
                          : '—'}
                      </TableCell>
                      <TableCell>
                        {transaction.salonShare != null
                          ? toTomans(transaction.salonShare)
                          : '—'}
                      </TableCell>
                      <TableCell>{transaction.tipRecipientName}</TableCell>
