...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      setUser(currentUser)
      if (!canAccessAdminDashboard(currentUser.role)) {
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-2">
        <Card  className="group hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-foreground/80 mt-2">مشتریان فعال</p>
          </CardContent>
        </Card>
        ...
        <Card  className="group hover:shadow-xl transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-foreground/80 mt-2">کارکنان فعال</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card  className="group hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-foreground/80 mt-1">نیاز به تأیید</p>
          </CardContent>
        </Card>
        ...
        <Card  className="group hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-foreground/80 mt-1">این ماه</p>
          </CardContent>
        </Card>
        ...
        <Card  className="group hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            ...
            <p className="text-xs text-foreground/80 mt-1">نوبت‌های موفق</p>
          </CardContent>
        </Card>
      </div>
