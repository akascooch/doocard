            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {toThousandTomans(dayClosingData.totalIncome)}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-red-600">
                  {toThousandTomans(dayClosingData.totalExpense)}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-yellow-600">
                  {toThousandTomans(dayClosingData.totalTips)}
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-blue-600">
                  {toThousandTomans(dayClosingData.totalSalaries)}
                </div>
              </CardContent>
            </Card>
          </div>
