        ...
        if (appointmentsData.length > 0) {
          ...
          setStats(prev => ({
            ...
            nextAppointment: {
              ...
              employee: nextAppointment.employee.user.name,
        ...
        <CardContent className="relative p-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <Button
              ...
              className="bg-white text-teal hover:bg-white/90 shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-lg px-8 py-6 h-auto font-bold"
            >
