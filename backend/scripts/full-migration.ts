...
async function importToZapas() {
  ...
  try {
    ...
    const importOrder = [
      'users', 'profiles', 'financialCategories', 'bankAccounts', 'services',
      'barbers', 'customers', 'appointments', 'appointmentServices',
      'financialEntries', 'transactions', 'salaries', 'tipTransactions',
      'barberWithdrawalRequests', 'settings', 'permissions', 'smsLogs',
...
async function fullMigration() {
  try {
    console.log('🚀 Starting full database migration from mova to zapas...');
